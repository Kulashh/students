package kz.bitlab.techorda.students.db;

import kz.bitlab.techorda.students.model.Student;
...
public class DBManager {
    ...
    static {
        studentList.add(new Student(1L,"Kulash","Bazarbayeva", 99, "A"));
        studentList.add(new Student(2L,"Salem","Privetov", 80, "B"));
